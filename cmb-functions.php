 ...
 *
 * Be sure to replace all instances of 'rawhide_' with your project's prefix.
 ...
 */
function rawhide_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function rawhide_hide_if_no_cats( $field ) {
 ...
 * @param  CMB2_Field object $field      Field object
 */
function rawhide_before_row_if_2( $field_args, $field ) {
...
function rawhide_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'rawhide_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'rawhide_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'rawhide_before_row_if_2', // callback
...
add_action( 'cmb2_init', 'rawhide_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function rawhide_register_about_page_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_rawhide_about_';
...
add_action( 'cmb2_init', 'rawhide_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function rawhide_register_repeatable_group_field_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_rawhide_group_';
...
add_action( 'cmb2_init', 'rawhide_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function rawhide_register_user_profile_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_rawhide_user_';
...
add_action( 'cmb2_init', 'rawhide_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function rawhide_register_theme_options_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$option_key = '_rawhide_theme_options';
